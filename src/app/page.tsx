  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="prose prose-lg mx-auto mb-16">
        <h2 className="text-3xl font-serif text-center mb-8">Discovering the Two-Kai Pattern</h2>
        <p>
      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>Explore the Two-Kai patterns with our interactive viewer, showing both Greek and English texts side by side.</p>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>Search through the Book of Revelation and discover the Two-Kai patterns in context.</p>
            <div className="card-actions justify-end">
