      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose mx-auto">
          ...
          <p>
            ...
            pattern, which he termed the "Two-Kai Configuration," reveals the intricate and
          ...
          <p>
            ...
            of Revelation. His work demonstrates how the careful use of the Greek word "καί" (kai)
          ...
          <div className="card bg-base-100 shadow-xl my-8">
            <div className="card-body">
              <blockquote className="text-lg italic">
                "The Two-Kai patterns reveal the remarkable precision with which the Book of
